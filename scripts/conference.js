! function(e) {
    ...
    function O(e, t) {
        e.isSubscribed && t.appendChild(e.track.attach()), e.on("subscribed", n => {
    ...
    function P(e) {
        e.tracks.forEach(e => {
            "audio" === e.kind ? O(e, i) : "video" === e.kind && "teacherScreen" !== e.trackName && (O(e, o), b = !0)
        }), e.on("trackPublished", e => {
            "audio" === e.kind ? O(e, i) : "video" === e.kind && "teacherScreen" !== e.trackName && (O(e, o), b = !0)
        })
    }
    ...
    function E(e) {
        v = e, setTimeout(() => {
            ...
            if (e.identity === h) P(e), b || (document.getElementById("noCameraImg").style.display = "block");
            else {
                const t = document.createElement("div");
                t.id = `audioPreview_${e.identity}`, T(e)
            }
    ...
    function C(e, t) {
        ...
        navigator.mediaDevices.enumerateDevices().then(o => {
            o.forEach(e => {
                "audioinput" === e.kind && g ? n = !0 : "videoinput" === e.kind && k && (i = !0)
            }), m = r.connect(e, {
                name: t,
                video: i,
                audio: n,
    ...
    function j(e, t, n) {
        navigator.mediaDevices.getUserMedia(e).then(e => {
            console.log("Got audio access"), g = !0, C(t, n)
        }).catch(e => {
            "NotAllowedError" == e.name && (console.log(e), g = !1, C(t, n))
        })
    }!async function() {
        ...
        navigator.mediaDevices.getUserMedia({
            ...
            "NotAllowedError" == e.name && (console.log(e), k = !1), j(i, t, r)
        }), a.onmouseout = (() => {
            ...
            if (null !== v || void 0 !== v) {
                !u.classList.contains("muted") && (! function(e) {
                    S(e, "video", "mute")
                }(v), u.classList.add("muted"), u.style.display = "none", l.style.display = "block", chrome.runtime.sendMessage({
                    type: "muteVideo",
                    teacher: h,
                    action: "mute",
                    roomName: r
            ...
            if (null !== v || void 0 !== v) {
                u.classList.contains("muted") && (! function(e) {
                    S(e, "video", "unmute")
                }(v), u.classList.remove("muted"), u.style.display = "block", l.style.display = "none", chrome.runtime.sendMessage({
                    type: "muteVideo",
                    teacher: h,
                    action: "unmute",
                    roomName: r
            ...
            if (null !== v || void 0 !== v) {
                !a.classList.contains("muted") && (! function(e) {
                    S(e, "audio", "mute")
                }(v), y = !0, a.classList.add("muted"), a.style.display = "none", c.style.display = "block", chrome.runtime.sendMessage({
                    type: "muteStudent",
                    teacher: h,
                    action: "mute",
                    roomName: r
            ...
            if (null !== v || void 0 !== v) {
                a.classList.contains("muted") && (! function(e) {
                    S(e, "audio", "unmute")
                }(v), y = !1, a.classList.remove("muted"), a.style.display = "block", c.style.display = "none", chrome.runtime.sendMessage({
                    type: "muteStudent",
                    teacher: h,
                    action: "unmute",
                    roomName: r
            ...
            null === v && void 0 === v || chrome.runtime.sendMessage({
                type: "raiseHand",
                teacher: h,
                roomName: r
            })
            ...
            switch (e.type) {
                case "muteStudents":
                    if ("mute" === e.action) y || (a.click(), _ && (c.style.display = "none", d.style.display = "inline-block"));
                    else if ("unmute" === e.action) y && (c.click(), _ && (d.style.display = "none"));
                    else if ("forceMute" === e.action) {
                        _ = !0;
                        const e = document.querySelector("li.dominant_speaker");
                        e && e.classList.remove("dominant_speaker"), y ? (c.style.display = "none", d.style.display = "inline-block") : (a.click(), c.style.display = "none", d.style.display = "inline-block")
                    } else "forceUnmute" === e.action && (_ = !1, y && (d.style.display = "none", c.click()))
            }
