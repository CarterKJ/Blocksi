! function(e) {
    ...
    t.constants = c, t.createBandwidthProfilePayload = function(e) {
        ...
        if ([
            ...
            }), "networkQuality" in e && (t.networkQualityConfiguration = {}, d(e.networkQuality) ? ["local", "remote"].forEach(function(n) {
    ...
    }, t.hidePrivateProperties = p, t.hidePrivateAndCertainPublicPropertiesInClass = function(e, t) {
        return function(n) {
            function r() {
                var e;
                ! function(e, t) {
        ...
        return !1
    }, t.isNonArrayObject = d, t.inRange = function(e, t, n) {
        return t <= e && e <= n
    }, t.makeUUID = function() {
    ...
    (function(e) {
        ...
        function l(e, n, r) {
            ...
            var u, g = "",
                O = !1,
                T = ["{", "}"];
            (p(n) && (O = !0, T = ["[", "]"]), S(n)) && (g = " [Function" + (n.name ? ": " + n.name : "") + "]");
            return _(n) && (g = " " + RegExp.prototype.toString.call(n)), k(n) && (g = " " + Date.prototype.toUTCString.call(n)), w(n) && (g = " " + f(n)), 0 !== a.length || O && 0 != n.length ? r < 0 ? _(n) ? e.stylize(RegExp.prototype.toString.call(n), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(n), u = O ? function(e, t, n, r, i) {
                for (var o = [], a = 0, c = t.length; a < c; ++a) E(t, String(a)) ? o.push(d(e, t, n, r, String(a), !0)) : o.push("");
                return i.forEach(function(i) {
                    i.match(/^\d+$/) || o.push(d(e, t, n, r, i, !0))
                }), o
            }(e, n, r, c, a) : a.map(function(t) {
                return d(e, n, r, c, t, O)
        ...
        t.debuglog = function(n) {
            if (b(o) && (o = e.env.NODE_DEBUG || ""), n = n.toUpperCase(), !a[n])
            ...
            date: "magenta",
            regexp: "red"
        }, t.isArray = p, t.isBoolean = h, t.isNull = v, t.isNullOrUndefined = function(e) {
            return null == e
        }, t.isNumber = y, t.isString = m, t.isSymbol = function(e) {
            return "symbol" == typeof e
        }, t.isUndefined = b, t.isRegExp = _, t.isObject = g, t.isDate = k, t.isError = w, t.isFunction = S, t.isPrimitive = function(e) {
    ...
    t.AccessTokenNotYetValidError = d, Object.defineProperty(c, 20105, {
        value: d
    });
    var p = function(e) {
        function t() {
    ...
    t.AccessTokenGrantsInvalidError = p, Object.defineProperty(c, 20106, {
        value: p
    });
    var h = function(e) {
        function t() {
    ...
    t.SignalingConnectionTimeoutError = m, Object.defineProperty(c, 53002, {
        value: m
    });
    var b = function(e) {
        function t() {
    ...
    t.SignalingIncomingMessageInvalidError = b, Object.defineProperty(c, 53003, {
        value: b
    });
    var _ = function(e) {
        function t() {
    ...
    t.RoomCompletedError = V, Object.defineProperty(c, 53118, {
        value: V
    });
    var F = function(e) {
        function t() {
    ...
    t.ParticipantIdentityInvalidError = F, Object.defineProperty(c, 53200, {
        value: F
    });
    var U = function(e) {
        function t() {
    ...
    t.ParticipantIdentityCharsInvalidError = W, Object.defineProperty(c, 53202, {
        value: W
    });
    var Q = function(e) {
        function t() {
    ...
    t.ParticipantMaxTracksExceededError = Q, Object.defineProperty(c, 53203, {
        value: Q
    });
    var q = function(e) {
        function t() {
    ...
    t.TrackNameTooLongError = $, Object.defineProperty(c, 53302, {
        value: $
    });
    var K = function(e) {
        function t() {
    ...
    t.TrackNameCharsInvalidError = K, Object.defineProperty(c, 53303, {
        value: K
    });
    var Y = function(e) {
        function t() {
    ...
    }, t.getMediaSections = p, t.getPlanBTrackIds = l, t.getUnifiedPlanTrackIds = f, t.getPlanBSSRCs = d, t.getUnifiedPlanSSRCs = v, t.updatePlanBTrackIdsToSSRCs = function(e, t) {
        return _(m, e, t)
    ...
    var f = function() {
        ...
        return i(e, [{
            ...
            value: function(t, n) {
                var r = e._levels[t];
                if (!r) throw u.INVALID_VALUE("logLevel", p);
                r = r.toLowerCase();
    ...
    var d = {},
        ...
        h = f._levels.map(function(e, t) {
            return d[e] = !0, p.push(t), e
        });

    function v(e) {
        if (!(e in d)) throw u.INVALID_VALUE("level", h)
    }
    ...
    function b(e, t) {
        ...
        return m(y(e).filter(function(e) {
            return s.includes(e)
        }), f.join("\r\n"))
    }
    ...
    t.createCodecMapForMediaSection = l, t.createPtToCodecName = d, t.disableRtx = function(e) {
        var t = v(e);
    ...
    var r = n(1).asLocalTrack,
        ...
        f = n(18),
        d = n(4),
        p = d.DEFAULT_LOG_LEVEL,
        h = d.DEFAULT_LOGGER_NAME,
        v = n(63),
        y = 0;
    e.exports = function(e) {
        ...
        var n = "[createLocalTracks #" + ++y + "]",
            a = i(e.logLevel),
            d = new e.Log("default", n, a, e.loggerName),
            m = Object.assign({
                log: d
            }, e);
        if (delete m.name, !1 === e.audio && !1 === e.video) return d.info("Neither audio nor video requested, so returning empty LocalTracks"), Promise.resolve([]);
        if (e.tracks) return d.info("Adding user-provided LocalTracks"), d.debug("LocalTracks:", e.tracks), Promise.resolve(e.tracks);
        var b = {
        ...
        b.audio.isCreatedByCreateLocalTracks = !0, b.video.isCreatedByCreateLocalTracks = !0, e.audio && "boolean" == typeof e.audio.workaroundWebKitBug1208516 && (b.audio.workaroundWebKitBug1208516 = e.audio.workaroundWebKitBug1208516), e.video && "boolean" == typeof e.video.workaroundWebKitBug1208516 && (b.video.workaroundWebKitBug1208516 = e.video.workaroundWebKitBug1208516), e.audio && delete e.audio.name, e.video && delete e.video.name;
        var _ = {
            audio: e.audio,
            video: e.video
        };
        return (e.audio && e.audio.workaroundWebKitBug180748 ? v(d, e.getUserMedia, _) : e.getUserMedia(_)).then(function(e) {
            var t = e.getAudioTracks().concat(e.getVideoTracks());
            return d.info("Call to getUserMedia successful; got MediaStreamTracks:", t), t.map(function(e) {
                return r(e, Object.assign(b[e.kind], m))
            })
        }, function(e) {
            throw d.warn("Call to getUserMedia failed:", e), e
        })
    }
}, function(e, t, n) {
    "use strict";
    ...
    function d(e, t, n) {
        ...
        var d = u();
        null == d && (d = null == t ? "WARN" : t), a.setLevel(d, !1)
    }
    var p = new d,
        h = {};
    p.getLogger = function(e) {
        ...
        var t = h[e];
        return t || (t = h[e] = new d(e, p.getLevel(), p.methodFactory)), t
    };
    var v = ("undefined" == typeof window ? "undefined" : r(window)) !== o ? window.log : void 0;
    p.noConflict = function() {
        return ("undefined" == typeof window ? "undefined" : r(window)) !== o && window.log === p && (window.log = v), p
    }, p.getLoggers = function() {
        return h
    }, p.default = p, e.exports = p
}, function(e, t, n) {
    "use strict";
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            return typeof e
    ...
    var a = n(8).getUserMedia,
        ...
        f = s.waitForSometime,
        d = s.waitForEvent,
        p = n(4).typeErrors.ILLEGAL_INVOKE,
        h = n(130),
        v = n(61),
        y = n(62),
        m = n(57),
    ...
    function g(e) {
        ...
        function s() {
            return Promise.race([d(o, "unmute"), f(50)]).then(function() {
                return c()
            }).then(function(t) {
                return t && !a && (a = l(), e._restart().finally(function() {
                    i = e._dummyEl, b(), o = e.mediaStreamTrack, p(), a.resolve(), a = null
                })), (a && a.promise || Promise.resolve()).finally(function() {
                    return m.resolveDeferred(n)
                })
            })
        }
        ...
        function u() {
            var t = e._log,
                n = e.kind;
            t.info("Muted"), t.debug("LocalMediaTrack:", e), m.startDeferred(n)
        }
        ...
        return function(t) {
            ...
            return function(e, t) {
                ...
                value: function(e) {
                    var t = this,
                        n = this.kind;
                    if (!this._isCreatedByCreateLocalTracks) return Promise.reject(p("restart", "can only be called on a Local" + u(n) + "Track that is created using createLocalTracks or createLocal" + u(n) + "Track."));
        ...
        h = function(e) {
            ...
            return function(e, t) {
                ...
                value: function(e, t) {
                    ...
                    } [e.kind].set(t, e), v(this, e, t), n.info("Added a new " + d.trackClass(e) + ":", t), n.debug(d.trackClass(e) + ":", e), e)
                }
            }, {
                ...
                value: function(e) {
                    ...
                    }(this, e), t.info("Added a new " + d.trackPublicationClass(e) + ":", e.trackSid), t.debug(d.trackPublicationClass(e) + ":", e), e)
                }
            }, {
                ...
                value: function() {
                    ...
                    function l(n) {
                        ...
                        c && d(n), t._trackSignalingUpdatedEventCallbacks.set(n.sid, function() {
                            if (c !== n.isSubscribed) {
                                if (c = n.isSubscribed) return void d(n);
                                ! function(e) {
                    ...
                    function d(r) {
                        ...
                        if (d && s === f.kind) {
                            var h = {
                                ...
                                v = "data" === s ? new d(l, f, h) : new d(l, f, i, function(e) {
                                    return u.updateSubscriberTrackPriority(l, e)
                                }, h);
                            t._addTrack(v, p, f.id)
                        }
                    }
                }
            }, {
                ...
                value: function(e, t) {
                    ...
                    var n = this._log;
                    return n.info("Removed a " + d.trackClass(e) + ":", t), n.debug(d.trackClass(e) + ":", e), e
                }
            }, {
                ...
                value: function(e) {
                    ...
                    var t = this._log;
                    return t.info("Removed a " + d.trackPublicationClass(e) + ":", e.trackSid), t.debug(d.trackPublicationClass(e) + ":", e), e
                }
            }, {
                key: "toJSON",
                value: function() {
                    return d.valueToJSON(this)
                }
            }]), t
        }();
            ...
            d && d < 67 ? e.getStats(function(e) {
                ...
                n(function(e) {
                    ...
                    return (c ? [t] : n).forEach(function(e) {
                        ...
                        var d = r("roundTripTime");
                        "number" == typeof d && (t.roundTripTime = Math.round(1e3 * d));
                        var h = r("jitter");
                        ...
                        "number" == typeof m && (t.frameRateSent = m);
                        var b = r("bytesReceived");
                        "number" == typeof b && (t.bytesReceived = b);
                        var _ = r("bytesSent");
                        ...
                        var S = r("audioLevel");
                        "number" == typeof S && (S = Math.round(S * p), c ? t.audioOutputLevel = S : t.audioInputLevel = S), s.push(t)
                    }), s
                }(e))
            }, r)
        })
    ...
    function _(e, t) {
        ...
        var d = a("packetsSent");
        "number" == typeof d && (c.packetsSent = d);
        var p = a("roundTripTime");
        "number" == typeof p && (c.roundTripTime = Math.round(1e3 * p));
        var h = a("jitter");
        ...
        "number" == typeof m && (c.packetsReceived = m);
        var b = a("framerateMean");
        return "number" == typeof b && (c.frameRateReceived = Math.round(b)), c
    }
    e.exports = function(e, t) {
            ...
            var n = y(e, "audio", "local"),
                ...
                d = r([
                    ...
                    return r.map(function(n) {
                        return function(e, t, n) {
                            return void 0 !== (n = n || {}).testForChrome || u ? m(e, t) : void 0 !== n.testForFirefox || l ? function(e, t, n) {
                                return new Promise(function(r, i) {
                                    e.getStats(t).then(function(e) {
                                        r([_(e, n)])
                                    }, i)
                                })
                            }(e, t, n.isRemote) : void 0 !== n.testForSafari || f ? void 0 !== n.testForSafari || "unified" === a() ? m(e, t) : Promise.reject(new Error(["getStats() is not supported on this version of Safari", "due to this bug: https://bugs.webkit.org/show_bug.cgi?id=192601"].join(" "))) : Promise.reject(new Error("RTCPeerConnection#getStats() not supported"))
                        }(e, n, Object.assign({
                            isRemote: o
                        }, t)).then(function(e) {
                            e.forEach(function(e) {
    ...
    function d(e, t, n) {
        ...
        if (!t && a && "answer" === n.type) r = function(e, t) {
            ...
            i = p(n), t ? e._pendingLocalOffer = i : e._pendingRemoteOffer = i, r = Promise.resolve(), e.signalingState !== u && r.then(function() {
        ...
        return r || e._peerConnection[s](p(n))
    }
    ...
    function u(e) {
        ...
        Object.defineProperties(this, {
            ...
            localDescription: {
                enumerable: !0,
                get: function() {
                    return d(this._peerConnection.localDescription, this._initiallyNegotiatedDtlsRole)
                }
            },
            signalingState: {
                enumerable: !0,
    ...
    o(u, r), Object.defineProperty(u.prototype, "peerIdentity", {
        ...
        return e = this._peerConnection.createAnswer().then(function(e) {
            return f(n, e), d(e, n._initiallyNegotiatedDtlsRole)
    ...
    i(l, r), l.prototype.addIceCandidate = function(e) {
        ...
        e = Object.assign({}, e);
        var t = this;
        if (e.offerToReceiveAudio && !this._audioTransceiver && (!s || !d(this, "audio"))) {
        ...
        if (e.offerToReceiveVideo && !this._videoTransceiver && (!s || !d(this, "video"))) {
    ...
    e.exports = function(e, t) {
        ...
        var S = j(t.environment, t.region),
            D = new x(Date.now(), b, t.eventListener);
        if ((t = Object.assign({
                eventObserver: D,
                wsServer: S
            }, t)).log = b, B && !N && "error" !== b.logLevel && "off" !== b.logLevel && (N = !0, b.warn(["Support for Safari 12.0 and below is limited because it does not support VP8.", "This means you may experience codec issues in Group Rooms. You may also", "experience codec issues in Peer-to-Peer (P2P) Rooms containing Android- or", "iOS-based Participants who do not support H.264. However, P2P Rooms", "with browser-based Participants should work. For more information, please", "refer to this guide: https://www.twilio.com/docs/video/javascript-v2-developing-safari-11"].join(" "))), "string" != typeof e) return L.reject(R.INVALID_TYPE("token", "string"));
        var V = Object.assign({}, t);
        if (delete V.name, "tracks" in t) {
        ...
        var Q = new(0, t.signaling)(t.wsServer, t);
        b.info("Connecting to a Room"), b.debug("Options:", t);
        var q = new u({
                maxAudioBitrate: t.maxAudioBitrate,
                maxVideoBitrate: t.maxVideoBitrate
            }),
            G = {
                audio: t.preferredAudioCodecs.map(W),
                video: t.preferredVideoCodecs.map(W)
            },
        ...
        return z.then(function(e) {
            return b.info("Connected to Room:", e.toString()), b.info("Room name:", e.name), b.debug("Room:", e), e
        }, function(e) {
            z._isCanceled ? b.info("Attempt to connect to a Room was canceled") : b.info("Error while connecting to a Room:", e)
        }), z
    }
}, function(e, t, n) {
    "use strict";
        ...
        S = function(e) {
            ...
            return function(e, t) {
                ...
                value: function() {
                    ...
                    if ("disconnected" !== this.state) {
                        ...
                        this.on("trackDisabled", i), this.on("trackEnabled", o), this.on("trackStopped", a), this._tracks.forEach(function(n) {
                            e._addLocalTrack(n, p.PRIORITY_STANDARD), e._getOrCreateLocalTrackPublication(n).catch(function(e) {
                    ...
                    return new Promise(function(a, c) {
                        i.on("updated", function s() {
                            ...
                            if (i.sid) {
                                ...
                                (t = O(r.tracks, e)) || (t = u(e, i, o, d), r._addTrackPublication(t)), "connected" === r._signaling.state && setTimeout(function() {
                ...
                value: function(e, t) {
                    ...
                    if (!i.includes(t.priority)) return Promise.reject(d.INVALID_VALUE("LocalTrackPublishOptions.priority", i));
                ...
                key: "publishTracks",
                value: function(e) {
                    if (!Array.isArray(e)) throw d.INVALID_TYPE("tracks", "Array of LocalAudioTrack, LocalVideoTrack, LocalDataTrack, or MediaStreamTrack");
                ...
                value: function(e) {
                    if ("object" !== (void 0 === e ? "undefined" : r(e)) || null === e) throw d.INVALID_TYPE("networkQualityConfiguration", "NetworkQualityConfiguration");
                    return ["local", "remote"].forEach(function(t) {
                        if (t in e && ("number" != typeof e[t] || isNaN(e[t]))) throw d.INVALID_TYPE("networkQualityConfiguration." + t, "number")
                    }), this._signaling.setNetworkQualityConfiguration(e), this
                }
            }, {
                key: "setParameters",
                value: function(e) {
                    if (void 0 !== e && "object" !== (void 0 === e ? "undefined" : r(e))) throw d.INVALID_TYPE("encodingParameters", "EncodingParameters, null or undefined");
                    return e ? ["maxAudioBitrate", "maxVideoBitrate"].forEach(function(t) {
                        if (void 0 !== e[t] && "number" != typeof e[t] && null !== e[t]) throw d.INVALID_TYPE("encodingParameters." + t, "number, null or undefined")
                    }) : null === e && (e = {
                        maxAudioBitrate: null,
                        maxVideoBitrate: null
        ...
        l = function(e) {
            function t(e, n, r) {
                ...
                return Object.defineProperties(a, {
                    ...
                    function(e, t) {
                        var n = e._log;
                        n.debug("Creating a new RemoteParticipant for each ParticipantSignaling in the RoomSignaling"), t.participants.forEach(d.bind(null, e)), n.debug("Setting up RemoteParticipant creation for all subsequent ParticipantSignalings that connect to the RoomSignaling"), t.on("participantConnected", d.bind(null, e)), t.on("dominantSpeakerChanged", function() {
    ...
    var r = n(35),
        ...
        l = n(1),
        f = l.flatMap,
        d = l.createRoomConnectEventPayload;
            ...
            O = new r(function(r, i, o) {
                var a = p,
                    ...
                    I = Object.assign({
                        ...
                        insights: R,
                        onIced: function(e) {
                            return o() ? (i(w), Promise.reject(w)) : (_.debug("Got ICE servers:", e), p.iceServers = e, g.setConfiguration(p), g.createAndOffer().then(function() {
                                if (o()) throw i(w), w;
                ...
                O.emit("event", D), S.once("connected", function(e) {
                    if (_.debug("Transport connected:", e), o()) i(w);
                        ...
                        n.setSignalingRegion(t), r(new y(n, e, S, g, p))
                    } else i(new u)
    ...
    function _(e) {
        return e.length ? (m = m || b(), e.reduce(function(e, t) {
            return m[Math.max(y[e], y[t])]
        })) : "new"
    }
    ...
    var i = n(78),
        ...
        d = n(17).getSdpFormat,
        p = n(4),
        h = p.DEFAULT_ICE_GATHERING_TIMEOUT_MS,
        v = p.DEFAULT_LOG_LEVEL,
        y = p.DEFAULT_SESSION_TIMEOUT_SEC,
        m = p.iceRestartBackoffConfig,
        b = n(22),
        _ = b.createCodecMapForMediaSection,
        g = b.disableRtx,
        k = b.enableDtxForOpus,
        w = b.getMediaSections,
        S = b.removeSSRCAttributes,
        O = b.revertSimulcastForNonVP8MediaSections,
        T = b.setBitrateParameters,
        P = b.setCodecPreferences,
        E = b.setSimulcast,
        C = b.unifiedPlanAddOrRewriteNewTrackIds,
        j = b.unifiedPlanAddOrRewriteTrackIds,
        R = b.unifiedPlanFilterLocalCodecs,
        L = n(27),
        x = n(12),
        ...
        S = function(e) {
            function t(e, n, r, i, u) {
                ! function(e, t) {
                    ...
                    TrackPrioritySignaling: d,
                    TrackSwitchOffSignaling: p,
                                        ...
                                        if (t.publishEvent("quality", "stats-report", {
                                            ...
                                            var o = function(e, t) {
                                                return (e = Object.assign({
                                                    ...
                                                    transportId: "",
                                                    writable: !1
                                                }, b(e || {}, null))).localCandidate = Object.assign({
                                                    candidateType: "host",
                                                    deleted: !1,
                                                    ip: "",
                                                    port: 0,
                                                    ...
                                                    relayProtocol: "udp",
                                                    url: ""
                                                }, b(e.localCandidate || {}, null)), e.remoteCandidate = Object.assign({
                                                    candidateType: "host",
                                                    ip: "",
                                                    port: 0,
                                                    priority: 0,
            ...
            return function(e, t) {
                ...
                value: function(e) {
                    var t = this._trackReceiverDeferreds.get(e) || m(),
            ...
            return i(e, [{
                ...
                value: function() {
                    ...
                    return ("firefox" === a() ? (t = (e = this).pc.getTransceivers().filter(function(e) {
                        ...
                        return e.receiver
                    }), Promise.all([d(t), d(n), e.pc.getStats()]).then(function(t) {
                        var n = r(t, 3),
                            i = n[0],
                            o = n[1],
                            a = n[2],
    ...
    function y(e, t, n, r) {
        return p(l, h(e), t, n, r)
    }

    function m(e, t, n, r) {
        return p(u, v(e), t, n, r)
    }
        ...
        try {
            for (var s, u = t.values()[Symbol.iterator](); !(i = (s = u.next()).done); i = !0) {
                ...
                if ("outbound-rtp" === l.type && !l.isRemote) {
                    ...
                    var d = y(e, t, l, r);
                    if (d) {
                        var p = t.get(l.remoteId);
                        d.next(r || d.trackId, l, p)
                    }
                }
            }
        } catch (e) {
    ...
    function S(e, t) {
        ...
        if (n) e.next(n);
            ...
            var u = !0,
                ...
                f = void 0;
            try {
                for (var d, p = t.values()[Symbol.iterator](); !(u = (d = p.next()).done); u = !0) {
                    var h = d.value;
    ...
    var i = n(17).getSdpFormat,
        ...
        d = n(27),
        p = n(1),
        h = p.createBandwidthProfilePayload,
        v = p.createMediaSignalingPayload,
        y = p.createSubscribePayload,
        m = p.getUserAgent,
        b = p.isNonArrayObject,
        _ = n(12),
        ...
        E = function(e) {
            function t(e, n, r, o, s, d) {
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, t), d = Object.assign({
                    Backoff: l,
                    InsightsPublisher: a,
                    NullInsightsPublisher: c,
                    TwilioConnection: u,
                    iceServers: null,
                    sdpFormat: i(d.sdpSemantics),
                    trackPriority: !0,
                    trackSwitchOff: !0,
                    userAgent: m()
                }, d);
                var p = function(e, t) {
                    ...
                    h = {};
                d.wsServerInsights && (h.gateway = d.wsServerInsights);
                var v = d.insights ? d.InsightsPublisher : d.NullInsightsPublisher;
                return Object.defineProperties(p, {
                        _accessToken: {
                            value: n
                        },
                        _automaticSubscription: {
                            value: d.automaticSubscription
                        },
                        _bandwidthProfile: {
                            value: d.bandwidthProfile
                        },
                        _dominantSpeaker: {
                            value: d.dominantSpeaker
                        },
                        _eventPublisher: {
                            value: new v(n, O, T, d.environment, d.realm, h)
                        },
                        _iceServersStatus: {
                            value: Array.isArray(d.iceServers) ? "overrode" : "acquire"
                        },
                        _localParticipant: {
                            value: r
                        },
                        ...
                        _networkQuality: {
                            value: b(d.networkQuality) || d.networkQuality
                        },
                        _options: {
                            value: d
                        },
                        ...
                        _trackPriority: {
                            value: d.trackPriority
                        },
                        _trackSwitchOff: {
                            value: d.trackSwitchOff
                        },
                        _twilioConnection: {
                            value: null,
                            writable: !0
                    ...
                    }), d.eventObserver && d.eventObserver.setPublisher(p._eventPublisher),
                    function(e) {
                        function t() {
                    ...
                    }(p), p.once("connected", function(e) {
                        var t = e.sid,
                            n = e.participant;
                        p._eventPublisher.connect(t, n.sid)
                    }), p
            }
            return function(e, t) {
                if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function, not " + typeof t);
                ...
                value: function() {
                    var e = this;
                    return 0 === this._sessionTimeoutMS ? null : (this._sessionTimer || (this._sessionTimer = new d(function() {
        ...
        var i = n(3).EventEmitter,
            ...
            d = function(e) {
                function t(e, n, r, i, s, u) {
                    ...
                    }), d._readyToConnect.promise.then(function(t) {
                        var i = t.roomSid,
                            o = t.participantSid,
                            a = d;
                        d.on("disconnected", function t(c) {
            ...
            O = function(e) {
                function t(e, n) {
                    ...
                    var r = function(e, t) {
                        if (!e) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                        return !t || "object" != typeof t && "function" != typeof t ? e : t
                    }(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, "early", d));
                    n = Object.assign({
                        helloBody: null,
                    ...
                    return r.on("stateChanged", function(e) {
                        ...
                        e in p && r.emit.apply(r, [p[e]].concat(n));
                        var o = {
                            name: e,
                            group: "signaling",
                            level: l[r.state]
    ...
    const r = n(115),
        ...
        c = document.getElementById("muteVideoBtn"),
        s = document.getElementById("unmuteVideoBtn"),
        u = document.getElementById("liTeacher"),
        l = document.getElementsByClassName("liTeacher")[0],
        f = document.getElementById("camTxt"),
        d = document.getElementById("raisehand"),
    ...
    function C(e, t, n) {
        ("audio" === t ? e.localParticipant.audioTracks : e.localParticipant.videoTracks).forEach(function(e) {
            "mute" === n ? e.track.disable() : e.track.enable()
        })
    }

    function j() {
        T = [], y.participants.forEach(e => {
            e.identity !== v && e.tracks.forEach(t => {
                !T.includes(e.identity) && T.length < O && t.track.isEnabled && !t.track.isSwitchedOff && "video" === t.kind && (T.push(e.identity), document.getElementById(`studentVideo_${e.identity}`).style.display = "")
            })
        });
        for (var e = O - T.length; e > 0;) T.length < O && P.forEach(e => {
            !T.includes(e) && T.length < O && (T.push(e), document.getElementById(`studentVideo_${e}`).style.display = "")
        }), e--;
        P.forEach(e => {
            T.includes(e) || (document.getElementById(`studentVideo_${e}`).style.display = "none")
        })
    }
    ...
    function R(e, t, n) {
        if (e.isSubscribed) {
            ...
            "video" === e.kind && (r.style.display = "block", r.setAttribute("id", `videoTag||${n.identity}`), r.setAttribute("class", "videoTag"), track.on("switchedOff", () => {
                console.log(`Remote track ${track} was switched off`), document.getElementById(`studentVideo_${n.identity}`).style.display = "none", T.includes(n.identity) && T.splice(T.indexOf(n.identity), 1), j()
            }), track.on("switchedOn", () => {
                console.log(`Remote track ${track} was switched on`), j()
            })), t.appendChild(r)
        }
        e.on("subscribed", r => {
            const i = r.attach();
            "video" === e.kind && (i.style.display = "block", i.setAttribute("id", `videoTag||${n.identity}`), i.setAttribute("class", "videoTag"), r.on("switchedOff", () => {
                console.log(`Remote track ${r} has switched off`), document.getElementById(`studentVideo_${n.identity}`).style.display = "none", T.includes(n.identity) && T.splice(T.indexOf(n.identity), 1), j()
            }), r.on("switchedOn", () => {
                console.log(`Remote track ${r} was switched on`), j()
            })), t.appendChild(i)
        }), e.on("unsubscribed", E)
    }

    function L(e) {
        S < O && T.push(e.identity), P.includes(e.identity) || P.push(e.identity), S++;
        const t = document.getElementById(`studentVideo_${e.identity}`);
        e.tracks.forEach(n => {
            "audio" === n.kind ? R(n, t, e) : (R(n, t, e), n.on("trackEnabled", () => {
                j()
            }), n.on("trackDisabled", () => {
                j()
            }))
    ...
    function x(e) {
        l.innerHTML = e.identity, e.tracks.forEach(t => {
            "audio" === t.kind ? R(t, u, e) : "video" === t.kind && "teacherScreen" !== t.trackName && (R(t, u, e), _ = !0)
    ...
    function A(e) {
        ...
        t.setAttribute("class", `studentVideoDiv_${e.identity}`), t.setAttribute("id", `studentVideo_${e.identity}`);
        const n = document.createElement("span");
        n.setAttribute("id", `studentSpan_${e.identity}`), n.setAttribute("class", "studentSpan"), n.innerHTML = e.identity, t.appendChild(n), S >= O && (t.style.display = "none"), document.getElementsByClassName("grid")[0].prepend(t)
    }
    ...
    function I(e, t) {
        if ("student" === t) {
            ...
            return Array.from(e.tracks.values()).filter(function(e) {
                return e.track
            }).map(function(e) {
                return e.track
            })
    ...
    function D(e) {
        console.log(`Room joined: ${e}`), y = e, setTimeout(() => {
            i.click(), c.click()
        }, 500), e.participants.forEach(e => {
            if (console.log(`Participant already connected: ${e.identity}`), e.identity === v) x(e), document.getElementById("liTeacher").style.visibility = "visible", _ || (document.getElementById("noCameraImg").style.display = "block");
            else {
                const t = document.createElement("div");
                t.id = `audioPreview_${e.identity}`, A(e), L(e)
            }
        }), e.on("participantConnected", e => {
            if (console.log(`New room connection: ${e.identity}`), e.identity === v) x(e), document.getElementById("liTeacher").style.visibility = "visible", _ || (document.getElementById("noCameraImg").style.display = "block");
            else {
                const t = document.createElement("div");
                t.id = `audioPreview_${e.identity}`, A(e), L(e)
            }
            ...
            e.identity === v ? (document.getElementById("liTeacher").style.visibility = "hidden", I(e, "teacher")) : (I(e, "student"), P.includes(e.identity) && P.splice(P.indexOf(e.identity), 1), j())
        })
    }
    ...
    function M(e, t) {
        ...
        navigator.mediaDevices.enumerateDevices().then(o => {
            o.forEach(e => {
                "audioinput" === e.kind && k ? n = !0 : "videoinput" === e.kind && w && (i = !0)
            }), b = r.connect(e, {
                name: t,
                video: i,
                audio: n,
    ...
    function N(e, t, n) {
        navigator.mediaDevices.getUserMedia(e).then(e => {
            console.log("Got audio access"), k = !0, M(t, n)
        }).catch(e => {
            "NotAllowedError" == e.name && (console.log(e), k = !1, M(t, n))
        })
    }!async function() {
        ...
        const e = await new Promise((e, t) => {
            chrome.runtime.sendMessage({
                ...
                n && n.error && t(n.error), chrome.runtime.onMessage.addListener(t => {
        ...
        navigator.mediaDevices.getUserMedia({
            ...
            "NotAllowedError" == e.name && (console.log(e), w = !1), N(l, t, u)
        }), i.onmouseout = (() => {
            ...
            if (null !== y || void 0 !== y) {
                !c.classList.contains("muted") && (! function(e) {
                    C(e, "video", "mute")
                }(y), c.classList.add("muted"), c.style.display = "none", s.style.display = "inline-block", chrome.runtime.sendMessage({
                    type: "muteVideo",
                    teacher: v,
                    action: "mute",
                    roomName: u
            ...
            if (null !== y || void 0 !== y) {
                c.classList.contains("muted") && (! function(e) {
                    C(e, "video", "unmute")
                }(y), c.classList.remove("muted"), c.style.display = "inline-block", s.style.display = "none", chrome.runtime.sendMessage({
                    type: "muteVideo",
                    teacher: v,
                    action: "unmute",
                    roomName: u
            ...
            if (null !== y || void 0 !== y) {
                !i.classList.contains("muted") && (! function(e) {
                    C(e, "audio", "mute")
                }(y), m = !0, i.classList.add("muted"), i.style.display = "none", o.style.display = "inline-block", chrome.runtime.sendMessage({
                    type: "muteStudent",
                    teacher: v,
                    action: "mute",
                    roomName: u
            ...
            if (null !== y || void 0 !== y) {
                i.classList.contains("muted") && (! function(e) {
                    C(e, "audio", "unmute")
                }(y), m = !1, i.classList.remove("muted"), i.style.display = "inline-block", o.style.display = "none", chrome.runtime.sendMessage({
                    type: "muteStudent",
                    teacher: v,
                    action: "unmute",
                    roomName: u
            ...
            null === y && void 0 === y || chrome.runtime.sendMessage({
                type: "raiseHand",
                teacher: v,
                roomName: u
            })
            ...
            switch (e.type) {
                case "muteStudents":
                    if ("mute" === e.action) m || (i.click(), g && (o.style.display = "none", p.style.display = "inline-block"));
                    else if ("unmute" === e.action) m && (o.click(), g && (p.style.display = "none"));
                    else if ("forceMute" === e.action) {
                        g = !0;
                        const e = document.querySelector("li.dominant_speaker");
                        e && e.classList.remove("dominant_speaker"), m ? (o.style.display = "none", p.style.display = "inline-block") : (i.click(), o.style.display = "none", p.style.display = "inline-block")
                    } else "forceUnmute" === e.action && (g = !1, m && (p.style.display = "none", o.click()))
            }
